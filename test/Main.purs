            ...
            case toObject blob of
                ...
                Just obj →
                    let
                        ...
                        parse _ _ = Nothing
                    in
                        Right $ Permission $ catMaybes $ foldr (\(Tuple k v) acc → parse k v : acc) Nil $ x
...
type ViewAccessKeyRes = (permission ∷ Permission)

main ∷ Effect Unit
main = do
    _ ← launchAff_ $ do
        let
            payload ∷ JsonRpcReq ViewAccessKeyReq
            payload =
                { jsonrpc: "2.0"
                , id: "dontcare"
                , method: "query"
        ...
        case x of
            ...
            Right { body: bodyjson } →
                let
                    error_result ∷ Either JsonDecodeError (JsonRpcRes ErrorResultRes)
